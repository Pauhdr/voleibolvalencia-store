...
const generateReceipt = () => {
  ...
  const htmlParts = [
    ...
    'body { font-family: Arial, sans-serif; padding: 40px; color: #333; line-height: 1.6; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    ...
    '.logo-box { width: 120px; height: 100px; border: 2px solid #ddd; background: #f8f9fa; display: flex; align-items: center; justify-content: center; color: #999; font-size: 12px; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    ...
    '.order-title { text-align: center; margin: 30px 0 20px 0; padding: 15px; background: #f97316 !important; color: white !important; font-size: 18px; font-weight: bold; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    ...
    'th { background: #f97316 !important; color: white !important; padding: 10px; text-align: left; font-weight: bold; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    'td { padding: 8px 10px; border-bottom: 1px solid #ddd; }',
    'tbody tr:nth-child(even) { background: #fff8f5 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    '.totals { margin-top: 20px; text-align: right; }',
    '.totals table { margin-left: auto; width: 300px; }',
    '.totals td { padding: 8px 15px; text-align: right; font-size: 12px; }',
    '.totals .total-row { font-weight: bold; font-size: 14px; background: #fff8f5 !important; color: #f97316; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    '.payment-info { margin-top: 30px; padding: 15px; background: #fff8f5 !important; border-left: 4px solid #f97316; font-size: 11px; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    ...
    '  .order-title, th, tbody tr:nth-child(even), .totals .total-row, .payment-info, .logo-box { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    '}',
    '</style>',
    '</head>',
    '<body>',
