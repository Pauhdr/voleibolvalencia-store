...
const generateReceipt = () => {
  ...
  const htmlParts = [
    ...
    '<head>',
    '<meta charset="UTF-8">',
    '<title>Confirmación de Pedido - #' + orderData.value.orderNumber.toString().padStart(4, '0') + '</title>',
    '<style>',
    ...
    '  .order-title, th, tbody tr:nth-child(even), .totals .total-row, .payment-info { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }',
    '}',
    '</style>',
    '</head>',
    '<body>',
    ...
    '<div><div class="label">Nº pedido:</div><div class="value">#' + orderData.value.orderNumber.toString().padStart(4, '0') + '</div></div>',
